...
public class BaseActivityBasePresenter implements BaseActivityContract.BasePresenter {
    ...
    @Inject
    public BaseActivityBasePresenter(BaseActivityPersistenceInteractor baseActivityPersistenceInteractor) {
