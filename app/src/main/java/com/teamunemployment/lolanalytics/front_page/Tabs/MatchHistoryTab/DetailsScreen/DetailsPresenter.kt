...
class DetailsPresenter(private val detailsInteractor: DetailsInteractor,
    ...
    private fun handleHealthyResponse(result: MatchPerformanceDetails, headToHeadPerformance: HeadToHeadStat) {
        ...
        view.setDamageTakenEarlyGameChart(result.damageTaken[EARLY_GAME].producePieChartData(context), "Damage Taken")
        view.setDamageTakenMidGameChart(result.damageTaken[MID_GAME].producePieChartData(context), "Damage Taken")
        view.setDamageTakenLateGameChart(result.damageTaken[LATE_GAME].producePieChartData(context), "Damage Taken")
