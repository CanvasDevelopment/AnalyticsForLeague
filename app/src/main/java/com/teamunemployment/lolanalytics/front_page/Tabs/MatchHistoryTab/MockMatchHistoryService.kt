...
//
//
////    override fun fetchMatches(numberOfMatches: Int, summonerId: Long, role: Int): Call<Result<ArrayListWrapper<String>>> {
...
////    }
////
////    override fun fetchMatches(numberOfMatches: Int, summonerId: Long, role: Int, champId: Int) {
