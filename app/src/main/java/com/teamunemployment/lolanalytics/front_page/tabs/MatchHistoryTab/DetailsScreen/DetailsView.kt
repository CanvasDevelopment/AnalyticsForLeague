...
class DetailsView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val detailsUrl = intent.getStringExtra(Constant.DetailsPage.detailsUrlKey)
    ...
    fun setHeroChamp(champUrl : String) {
        Picasso.get().load(champUrl).into(heroChamp)
    }

    fun setEnemyChamp(champUrl : String) {
        Picasso.get().load(champUrl).into(enemyChamp)
    }
}