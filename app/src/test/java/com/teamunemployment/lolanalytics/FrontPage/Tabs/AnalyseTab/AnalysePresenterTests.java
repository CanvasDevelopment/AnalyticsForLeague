...
public class AnalysePresenterTests {
     ...
     *      Set the data to the data list.
     *      Set our adapter to the view
     *      Notify the adapter that data has changed.
     *      If we have no items in our datalist, set the placeholder that says -no data in role.
     ...
     *
     * UPDATE ROLE
     *      We need to be able to update the role of a user, and refetch the data.
     *
     * UPDATE CHAMP
     *      We need to be able to update the role of a champ, and refeetch the data.
     *
     * HANDLE CARD BINDING
